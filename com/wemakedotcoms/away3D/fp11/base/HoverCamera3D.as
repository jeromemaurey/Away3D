package com.wemakedotcoms.away3D.fp11.base
{
	...
	/**
	 * 
	 * HoverCamera3D is based on the Away3D 3.6 class but uses signals for event mapping
	 * 
	 * Just call camera.hover() in the render loop to animate. Use hover(true) to jump
	 * directly to the target pan/tilt angles
	 * 
	 * @author jerome at wemakdotcoms.com
	 * 
	 */	
